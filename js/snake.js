...
SNAKE.Snake = SNAKE.Snake || (function () {
    ...
    return function (config) {
      ...
      me.go = function () {
        ...
        EB.publish('move', {position: {x: newHead.row, y: newHead.col}, direction: myDirection})
...
SNAKE.Food = SNAKE.Food || (function () {
    ...
    return function (config) {
      ...
      me.randomlyPlaceFood = function () {
        ...
        EB.publish('set apple position', {x: fRow, y: fColumn})
      };
    };
  })();
      ...
      me.setupPlayingField = function () {
        ...
        myKeyListener = function (evt) {
          ...
          if (me.getBoardState() === 1) {
            ...
            EB.unsubscribe('keydown', myKeyListener)
            EB.subscribe('keydown', myKeyListener)
